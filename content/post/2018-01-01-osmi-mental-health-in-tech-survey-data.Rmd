...
## Conclusion
Often times an employee with mental health issues will not seek treatment because they fear its effect on their work. But in this analysis, we have seen how employees who seek treatment feel about their workplace in relation to their mental health. Analyses similar to the one I have presented can contribute to, or potentially ignite further, much better research about mental health at workplaces. There is a lot more data than what I was able to present here and so there are a number of ideas that can be applied to this data, such as:
